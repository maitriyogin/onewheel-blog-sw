...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app onewheel-blog-sw
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app onewheel-blog-sw-staging
  ```
