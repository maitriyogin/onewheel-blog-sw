...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  if (!post) {
    // this is will render the Catch boundary
...
export const action: ActionFunction = async ({ request, params }) => {
  ...
  // check the types of the data, form data is totally untyped could be another form...
  ...
  return redirect(slug == "new" ? "posts" : `/posts/${slug}`);
};
...
export default function NewPostRoute() {
  ...
  //   blah();
  // });
  const transition = useTransition(); // pending ui
      ...
      <Form method="post" key={data.post?.slug ?? "new"}>
        ...
        <p>
          <label>
            ...
            />
            {!isNewPost ? (
              <input type="hidden" name="slug" defaultValue={data.post?.slug} />
            ) : null}
          </label>
        </p>
        <p>
